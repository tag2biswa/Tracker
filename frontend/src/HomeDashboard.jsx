...
const NAV_ITEMS = [
  ...
  { id: "chatbot", to: "/chatbot", label: "Chat Bot", icon: "chat" }, // ✅ added ChatBot
    ...
    <div className={`home-dashboard theme-vibrant ${collapsed ? "collapsed" : ""}`}>
          ...
          <ul>
            {filteredItems.map((item) => (
              <li key={item.id} className="nav-item">
                ...
                <span className="nav-tooltip" role="tooltip" aria-hidden="true">
                  {item.label}
                </span>
              </li>
            ))}
      ...
      <main className="main-content" role="main">
        <Routes>
          ...
          <Route
            path="/activities"
            element={<ActivityOverview activities={window.__TRACKER_ACTIVITIES__ ?? []} />}
          />
          <Route
            path="/tracking-apps"
            element={<TrackedIdentifiersManager refreshKey={refreshCounter} />}
          />
          <Route path="/chatbot" element={<ChatBot />} /> {/* ✅ added route */}
          <Route
            path="/settings"
            element={
    ...
    case "settings":
      return (
        <svg {...common}>
          ...
          <path d="M19.4 15a1.7 1.7 0 00.3 1.9l.1.1a1 1 0 01-.1 1.4 12 12 0 01-2.2 1.6" />
        </svg>
      );
    case "logout":
      return (
        <svg {...common}>
          ...
          <path d="M21 12H9" />
          <path d="M13 19H6a2 2 0 01-2-2V7a2 2 0 012-2h7" />
        </svg>
      );
    default:
      return null;
